                ...
                <div className="container text-gray-600 px-6 mx-auto md:divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                    ...
                    <div className="justify-center pb-6 lg:justify-between">
                        <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                            ...
                            <Link rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900">
                            ...
                            <Link rel="noopener noreferrer" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900">
